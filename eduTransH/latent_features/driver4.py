...
X = pd.read_csv("/home/sk/IIITB/sem2/EduEmbed/code/data/triples_with_prob_old.csv")
...
def train_model(epochs, batches_count, k, structural_wt, lr, entities=entities, relations=relations):
    ...
    model.fit(train_triples, focusE_numeric_edge_values=train_weights)

    path = '/home/sk/IIITB/sem2/EduEmbed/code/embeddings_final/transH/'
