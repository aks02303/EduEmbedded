...
entities = pd.read_csv('embeddings_final/transH/transH_50_5_50_0.1_0.1/entities.csv', header=None)
entities_embeddings = pd.read_csv('embeddings_final/transH/transH_50_5_50_0.1_0.1/entity_embeddings.csv', header=None)

relations = pd.read_csv('embeddings_final/transH/transH_50_5_50_0.1_0.1/relations.csv', header=None)
relations_embeddings = pd.read_csv('embeddings_final/transH/transH_50_5_50_0.1_0.1/relation_embeddings.csv', header=None)
