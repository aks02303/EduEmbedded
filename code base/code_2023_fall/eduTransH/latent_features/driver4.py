...
TRANSH_OUTPUT_PATH = r'C:\Users\patel\OneDrive - iiit-b\Desktop\coursework\WSL Knowledge Graphs\codeBase\newCode\code base\code_2023_fall\embeddings_final\transH_without_weights'
...
def train_model(epochs, batches_count, k, structural_wt, lr, entities=entities, relations=relations):
    ...
    path = r'C:\Users\patel\OneDrive - iiit-b\Desktop\coursework\WSL Knowledge Graphs\codeBase\newCode\code base\code_2023_fall\embeddings_final\transH_without_weights'
...
hyperparameter_result.to_csv(relpath+'/embeddings_final/output/transH_without_weights_hyperparam_result.csv')
